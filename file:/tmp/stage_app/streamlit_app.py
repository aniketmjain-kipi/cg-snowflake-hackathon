...
st.markdown("""
<style>
    /* ── Override Streamlit primary color (controls button press color) ── */
    :root {
    ...
    /* ── Quick question buttons: blue when selected ── */
    ...
    div[data-testid="stBaseButton-secondary"]:active button,
    div[data-testid="stBaseButton-secondary"]:focus-within button,
